...
public class ResourceManager {
    ...
    public Sprite getEvilBullet(){
    	return evilbulletSprite;
    }
    ...
    */
    ...
    public TileMap inputMap() {
        ...
        while (map == null) {
            try {
        		filename = "maps/" + input.nextLine(); 
                map = loadMap(filename);
            }catch (IOException ex) {
            	System.out.println("Need a correct filename.");
                map = null;
            }
        }
        currentMap = filename.charAt(8) - '0';
        return map;
    }
        ...
        for (int y=0; y<height; y++) {
            ...
            for (int x=0; x<line.length(); x++) {
                ...
                // check if the char represents a sprite
                	...
                	addSprite(newMap, TNTSprite, x, y);
                }
            }
        }
    ...
    private void loadPowerUpSprites() {
        ...
        // create "Bullet"
        anim = new Animation();
        Image image = loadImage("bullet.png");
        ...
        //create "TNT"
        anim = new Animation();
        image = loadImage("TNT.png");
        anim.addFrame(image, 150);
        TNTSprite = new PowerUp.TNT(anim);
    }
