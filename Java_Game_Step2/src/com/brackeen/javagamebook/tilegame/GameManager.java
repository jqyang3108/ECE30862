...
public class GameManager extends GameCore {
    ...
    public void init() {
        ...
        hpSound = soundManager.getSound("sounds/hp.wav");
        gasSound = soundManager.getSound("sounds/gas.wav");
        TNTSound = soundManager.getSound("sounds/tnt.wav");
    ...
    */
    ...
    private long poisonedTime = System.currentTimeMillis();
    ...
    */
    public void update(long elapsedTime) {
        ...
        if(player_player.invincible){
        	long invinciblenow = System.currentTimeMillis();
        	if(invinciblenow - invincibleTime >= 10000){
        		player_player.invincible = false;
        		invincibleTime = System.currentTimeMillis();
        	}
        }
        if(poisoned && !player_player.invincible){
        	long poisonnow = System.currentTimeMillis();
        	if(poisonnow - poisonedTime >= 5000){
        		poisoned = false;
    ...
    */ 
        ...
        long elapsedTime)
    {
        ...
        Point tile_b = getTileCollision(creature, newX, creature.getY());
        Sprite collisionSprite;
        if(creature instanceof Bullet){
        	collisionSprite = getSpriteCollision(creature);
        	if(collisionSprite instanceof PowerUp.TNT ||
        			collisionSprite instanceof PowerUp.Gas){
    ...
    */
    public void acquirePowerUp(PowerUp powerUp) {
        ...
        if (powerUp instanceof PowerUp.Star) {
        	...
        	soundManager.play(hpSound);
        }
        else if(powerUp instanceof PowerUp.TNT){
        	soundManager.play(TNTSound);
    	}
    }
